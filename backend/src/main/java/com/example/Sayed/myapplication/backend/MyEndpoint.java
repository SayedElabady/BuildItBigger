...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.Sayed.example.com",
                ownerName = "backend.myapplication.Sayed.example.com",
                packagePath = ""
        )
)
public class MyEndpoint {
    JokesTeller jokesTeller;
    public MyEndpoint(){
        jokesTeller = new JokesTeller();
    }
    /**
